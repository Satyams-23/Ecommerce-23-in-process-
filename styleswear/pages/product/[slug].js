    ...
    return (<>
        <section className="text-gray-600 body-font overflow-hidden">
            <div className="container px-5 py-24 mx-auto">
                <div className="lg:w-5/5  flex flex-wrap justify-center">
                    <img alt="ecommerce" className="lg:w-1/4 w-full lg:h-auto h-64 px-18 py-6 object-cover object-top rounded" src="https://m.media-amazon.com/images/I/61tM2jn7LQL._UX569_.jpg" />
                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        ...
                        <div className="flex ">
                            ...
                            <button className="flex ml-32 text-white bg-blue-500 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded">Add to cart</button>
