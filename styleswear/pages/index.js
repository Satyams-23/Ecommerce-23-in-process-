...
export default function Home() {
  return (
    <div>
      ...
      <div>
        <img src="/bg.png" width={1600} height={900} alt="" />
      </div>
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
            <h1 className="sm:text-3xl text-2xl  pb-3 font-bold title-font mb-2 text-gray-900">Wear Only The Stylish Dress : &lt; Stylishwear.com /&gt;</h1>
            <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Whatever cardigan  brooklyn asymmetrical gentrify, subway tile poke farm-to-table.</p>
            <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Whatever cardigan  brooklyn asymmetrical gentrify, subway tile poke farm-to-table.</p>
            <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Whatever cardigan  brooklyn asymmetrical gentrify, subway tile poke farm-to-table.</p>
          </div>
